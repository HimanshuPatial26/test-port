/** Small, allocation-free noise helpers used when building geometry on the CPU. */
...
// 3D simplex noise (Stefan Gustavson's public-domain reference, compacted).
...
export class Simplex3 {
  ...
  /** Ridged multifractal in [0, 1] – sharp creases, good for fracture relief. */
